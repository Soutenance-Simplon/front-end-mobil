...
class _WalletScreenState extends ConsumerState<WalletScreen> {
  ...
  void _showDepotDialog() {
    ...
    final telCtrl = TextEditingController(text: "+221 77 000 00 00");
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: InkWell(
                                  onTap: () => setDialogState(() => paymentMethod = "Wave"),
                                ...
                                child: InkWell(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(16),
                                      border: Border.all(
                                        color: paymentMethod == "Orange Money" ? const Color(0xFFFF9F65) : Colors.transparent,
                                        width: 2,
                                      ),
                                    ),
                                ...
                                child: Container(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      ...
                                      final ok = await ref.read(walletProvider.notifier).recharger(
                                            montant: amount,
                                            moyenPaiement: paymentMethod.toUpperCase(),
                                            numeroTelephone: telCtrl.text,
                                          );
  ...
  void _showAddBeneficiaireDialog() {
    ...
    final plafondCtrl = TextEditingController(text: "25000");
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              filled: true,
                              fillColor: const Color(0xFFF8F9FA),
                              prefixIcon: const Icon(Icons.person_outline_rounded, color: Color(0xFF8E95A5)),
                              border: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: BorderSide.none),
                              contentPadding: const EdgeInsets.symmetric(vertical: 16),
                            ),
                          ),
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      if (nameCtrl.text.trim().isNotEmpty) {
                                        setState(() {
                                          _beneficiaires.add({
                                            ...
                                            "plafond": double.tryParse(plafondCtrl.text.trim()) ?? 25000,
                                          });
                                        });
                                    ...
                                    child: const Text("Ajouter", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                                  ),
                                ),
                              ),
                            ],
  ...
  Widget build(BuildContext context) {
    ...
    final beneficiairesAffiches = walletState.mesBeneficiaires.isNotEmpty
        ? walletState.mesBeneficiaires
        : _beneficiaires;
            ...
            child: RefreshIndicator(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          _showBalance ? "${solde.toStringAsFixed(0)} FCFA" : "•••••••• FCFA",
                  ...
                  if (beneficiairesAffiches.isEmpty)
                    Container(
                    ...
                    ...beneficiairesAffiches.map((beneficiaire) {
                      ...
                      final nom = beneficiaire['nomBeneficiaire'] ??
                          ...
                          WalletApiService.getNomUtilisateur(
                            bUserId,
                            fallbackLien: beneficiaire['lienParente']?.toString() ?? beneficiaire['lien']?.toString(),
                          );
                      final rawLien = beneficiaire['lienParente']?.toString() ?? beneficiaire['lien']?.toString() ?? 'Autre';
                      final lienFormate = rawLien.length > 1
                          ? (rawLien.substring(0, 1).toUpperCase() + rawLien.substring(1).toLowerCase())
                          : rawLien;
                      final plafond = beneficiaire['plafondMensuel'] ?? beneficiaire['plafond'];
